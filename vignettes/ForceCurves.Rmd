...
force_img <- AFM.import(f)
force_img <- AFM.flatten(force_img)
plot(force_img) + labs(fill = "z (nm)")
```

Spectroscopy data files are recognized as such:

```{r}
AFM.dataType(force_img)
```
